...
As [Google Colaboratory](https://colab.research.google.com/notebooks) was used for the entire project, I strongly recommend to use this platform as well when running the notebooks. Unzipping the zip file referenced above and putting this in your own drive should allow you to run all the notebooks of this project in the Google Colaboratory platform.

## Libararies, Modules & Packages 

The following libararies, modules and packages are used in this project:
```bash
Numpy
Keras
TensorFlow
